      ...
      >
        <div className="rounded-xl p-10 border border-noir-gray bg-noir-dark backdrop-blur-sm shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="font-mono text-neutral-400 text-lg">Welcome back to Vibe Prompting</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <input
                  ...
                  className="w-4 h-4 rounded border-noir-gray bg-noir-black text-noir-yellow focus:ring-noir-yellow/50"
                />
                <span className="text-sm text-neutral-400">Remember me</span>
              </label>
              <Link
                to="/forgot-password"
                className="text-sm font-medium text-noir-yellow hover:text-noir-glow transition-colors"
              >
                Forgot password?
              </Link>
            </div>
